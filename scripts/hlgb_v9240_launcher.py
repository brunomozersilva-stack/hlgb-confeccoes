...
# Aplica por último a otimização de memória do Chrome, depois dos demais patches.
runpy.run_path('scripts/hlgb_v9240_memory_patch.py', run_name='__main__')
...
print('launcher v92.40 com cache-bust dinâmico e memória otimizada')
