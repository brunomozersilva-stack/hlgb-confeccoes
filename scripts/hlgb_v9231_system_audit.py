...
s=s.replace("window.hlgb955FlushNow=()=>flush955(true);","window.hlgb955FlushNow=()=>flush955(true);window.hlgb955FlushSilent=()=>flush955(false);",1)
